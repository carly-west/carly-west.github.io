const apiURL = 'https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=b8b0e14937e799b298d79cb51cfa495e&units=imperial';
...
// I used my classmates website to help me finish this portion.
  ...
  .then((jsObject) => {
    ...
    for (let i = 0; i < [1]; i++ ) {
      document.getElementById('event1').textContent = towns[0].events[0];
      document.getElementById('event2').textContent = towns[0].events[1];
      document.getElementById('event3').textContent = towns[0].events[2];
    }
